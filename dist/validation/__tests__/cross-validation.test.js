...
import { checkCrossValidation, getBlockingValidations, hasBlockingValidations, formatValidationResults, CROSS_VALIDATION_RULES, } from '../cross-validation.js';
function makeEvidence(step, reviewerAgent, linesAdded = 0, linesRemoved = 0) {
    return {
        skill: 'ralph',
        step,
        phase: 'verifying',
...
//# sourceMappingURL=cross-validation.test.js.map