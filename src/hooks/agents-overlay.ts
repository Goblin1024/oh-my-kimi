 ...
 */
export function resolveAgentForSkill(skill: string): string {
 ...
 */
export function loadAgentPrompt(promptFile: string): string | null {
 ...
 */
export function injectOverlay(skill: string): string {
