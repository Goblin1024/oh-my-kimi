 ...
 */
export function recoverFromCrash(skill, cwd) {
 ...
 */
function getCanonicalPhaseOrder(skill) {
    const known = {
 ...
 */
export function formatRecoveryMessage(result) {
    if (!result.recovered) {
        return '';
    }
    const lines = [
 ...
 */
export function buildRecoveredState(skill, result) {
    return {
        skill,
        active: true,
        phase: result.phase,
...
//# sourceMappingURL=auto-progress.js.map