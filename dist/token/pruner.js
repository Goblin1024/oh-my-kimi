 ...
 */
export function shouldPrune(sessionTokenUsage, budget) {
    return sessionTokenUsage / budget > 0.7;
}
/**
 * Generate a concise summary of command output.
 */
export function generateSummary(output) {
 ...
 */
export function compressEvidence(ev) {
 ...
 */
export function getPruningRecommendations(evidence, sessionTokenUsage, budget) {
