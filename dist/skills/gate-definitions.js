 ...
 */
export function checkShortcutKeywords(prompt) {
 ...
 */
export function checkVerificationPlan(prompt) {
    const lower = prompt.toLowerCase();
 ...
 */
export function checkDecomposition(prompt) {
 ...
 */
export function checkFlagSemantic(prompt, flags, _skill) {
    if (flags.length === 0) {
        return {
            passed: true,
 ...
 */
export function runSemanticGates(prompt, flags = [], skill = '') {
    return [
 ...
 */
export function hasBlockingGates(results) {
...
//# sourceMappingURL=gate-definitions.js.map