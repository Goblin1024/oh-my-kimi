 ...
 */
export function generateSystemPrompt(def) {
 ...
 */
export function generateAgentTOML(def) {
    const lines = [
 ...
 */
export function generateAllAgentTOMLs() {
    const result = {};
 ...
 */
export function writeAgentTOMLs(targetDir) {
 ...
 */
export function previewAgentTOMLs() {
