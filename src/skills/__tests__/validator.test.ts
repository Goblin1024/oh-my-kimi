  ...
  describe('validateFlags', () => {
    ...
    it('returns valid for a known flag', () => {
      const result = validateFlags(
        'ralph',
        '$ralph --prd implement the auth module',
        process.cwd()
      );
      assert.equal(result.valid, true);
    });
    ...
    it('returns invalid for an unknown flag', () => {
      const result = validateFlags(
        'ralph',
        '$ralph --unknown-flag implement something',
        process.cwd()
      );
    ...
    it('accepts known ralplan flags', () => {
      const result = validateFlags(
        'ralplan',
        '$ralplan --deliberate build the auth system',
        process.cwd()
      );
      assert.equal(result.valid, true);
    });
  ...
  describe('checkGates', () => {
    it('passes prompt_specificity gate with a detailed prompt', () => {
      const results = checkGates(
        'ralph',
        '$ralph implement the user authentication module',
        process.cwd()
      );
